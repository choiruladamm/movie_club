...
class DetailTopRatedMoviesSiji extends StatefulWidget {
  const DetailTopRatedMoviesSiji({super.key});

  @override
  State<DetailTopRatedMoviesSiji> createState() => _DetailTopRatedMoviesSijiState();
}

class _DetailTopRatedMoviesSijiState extends State<DetailTopRatedMoviesSiji> {
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10),
                          Text(
                            snapshot.data[1]["vote_average"].toString(),
                            style: TextStyle(
                              color: Colors.amber,
                              fontSize: 18,
                            ),
