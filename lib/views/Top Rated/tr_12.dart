...
class DetailTopRatedMoviesRollas extends StatefulWidget {
  const DetailTopRatedMoviesRollas({super.key});

  @override
  State<DetailTopRatedMoviesRollas> createState() => _DetailTopRatedMoviesRollasState();
}

class _DetailTopRatedMoviesRollasState extends State<DetailTopRatedMoviesRollas> {
