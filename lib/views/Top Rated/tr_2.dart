...
class DetailTopRatedMoviesLoro extends StatefulWidget {
  const DetailTopRatedMoviesLoro({super.key});

  @override
  State<DetailTopRatedMoviesLoro> createState() => _DetailTopRatedMoviesLoroState();
}

class _DetailTopRatedMoviesLoroState extends State<DetailTopRatedMoviesLoro> {
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10),
                          Text(
                            snapshot.data[2]["vote_average"].toString(),
                            style: TextStyle(
                              color: Colors.amber,
                              fontSize: 18,
                            ),
