...
class DetailTopRatedMoviesLimo extends StatefulWidget {
  const DetailTopRatedMoviesLimo({super.key});

  @override
  State<DetailTopRatedMoviesLimo> createState() => _DetailTopRatedMoviesLimoState();
}

class _DetailTopRatedMoviesLimoState extends State<DetailTopRatedMoviesLimo> {
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10),
                          Text(
                            snapshot.data[5]["vote_average"].toString(),
                            style: TextStyle(
                              color: Colors.amber,
                              fontSize: 18,
                            ),
