...
class DetailTopRatedMovies extends StatefulWidget {
  const DetailTopRatedMovies({super.key});

  @override
  State<DetailTopRatedMovies> createState() => _DetailTopRatedMoviesState();
}

class _DetailTopRatedMoviesState extends State<DetailTopRatedMovies> {
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10),
                          Text(
                            snapshot.data[0]["vote_average"].toString(),
                            style: TextStyle(
                              color: Colors.amber,
                              fontSize: 18,
                            ),
