...
class UpComingMoviesRollas extends StatefulWidget {
  const UpComingMoviesRollas({super.key});

  @override
  State<UpComingMoviesRollas> createState() => _UpComingMoviesRollasState();
}

class _UpComingMoviesRollasState extends State<UpComingMoviesRollas> {
