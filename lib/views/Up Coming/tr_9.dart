...
class UpComingMoviesSongo extends StatefulWidget {
  const UpComingMoviesSongo({super.key});

  @override
  State<UpComingMoviesSongo> createState() => _UpComingMoviesSongoState();
}

class _UpComingMoviesSongoState extends State<UpComingMoviesSongo> {
