...
class UpComingMoviesTelu extends StatefulWidget {
  const UpComingMoviesTelu({super.key});

  @override
  State<UpComingMoviesTelu> createState() => _UpComingMoviesTeluState();
}

class _UpComingMoviesTeluState extends State<UpComingMoviesTelu> {
