...
class UpComingMoviesWolu extends StatefulWidget {
  const UpComingMoviesWolu({super.key});

  @override
  State<UpComingMoviesWolu> createState() => _UpComingMoviesWoluState();
}

class _UpComingMoviesWoluState extends State<UpComingMoviesWolu> {
