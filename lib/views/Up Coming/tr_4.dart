...
class UpComingMoviesPapat extends StatefulWidget {
  const UpComingMoviesPapat({super.key});

  @override
  State<UpComingMoviesPapat> createState() => _UpComingMoviesPapatState();
}

class _UpComingMoviesPapatState extends State<UpComingMoviesPapat> {
