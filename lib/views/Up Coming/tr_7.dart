...
class UpComingMoviesPitu extends StatefulWidget {
  const UpComingMoviesPitu({super.key});

  @override
  State<UpComingMoviesPitu> createState() => _UpComingMoviesPituState();
}

class _UpComingMoviesPituState extends State<UpComingMoviesPitu> {
