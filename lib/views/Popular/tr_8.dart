...
class PopularMoviesWolu extends StatefulWidget {
  const PopularMoviesWolu({super.key});

  @override
  State<PopularMoviesWolu> createState() => _PopularMoviesWoluState();
}

class _PopularMoviesWoluState extends State<PopularMoviesWolu> {
