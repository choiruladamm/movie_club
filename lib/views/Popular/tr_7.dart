...
class PopularMoviesPitu extends StatefulWidget {
  const PopularMoviesPitu({super.key});

  @override
  State<PopularMoviesPitu> createState() => _PopularMoviesPituState();
}

class _PopularMoviesPituState extends State<PopularMoviesPitu> {
