...
class PopularMoviesSiji extends StatefulWidget {
  const PopularMoviesSiji({super.key});

  @override
  State<PopularMoviesSiji> createState() => _PopularMoviesSijiState();
}

class _PopularMoviesSijiState extends State<PopularMoviesSiji> {
