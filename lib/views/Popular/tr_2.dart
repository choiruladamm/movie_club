...
class PopularMoviesLoro extends StatefulWidget {
  const PopularMoviesLoro({super.key});

  @override
  State<PopularMoviesLoro> createState() => _PopularMoviesLoroState();
}

class _PopularMoviesLoroState extends State<PopularMoviesLoro> {
