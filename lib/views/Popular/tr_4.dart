...
class PopularMoviesPapat extends StatefulWidget {
  const PopularMoviesPapat({super.key});

  @override
  State<PopularMoviesPapat> createState() => _PopularMoviesPapatState();
}

class _PopularMoviesPapatState extends State<PopularMoviesPapat> {
