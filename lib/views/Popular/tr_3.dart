...
class PopularMoviesTelu extends StatefulWidget {
  const PopularMoviesTelu({super.key});

  @override
  State<PopularMoviesTelu> createState() => _PopularMoviesTeluState();
}

class _PopularMoviesTeluState extends State<PopularMoviesTelu> {
