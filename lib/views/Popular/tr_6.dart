...
class PopularMoviesEnem extends StatefulWidget {
  const PopularMoviesEnem({super.key});

  @override
  State<PopularMoviesEnem> createState() => _PopularMoviesEnemState();
}

class _PopularMoviesEnemState extends State<PopularMoviesEnem> {
